  ...
  RawRepresentableCalendarComponent, Year
{
  ...
  public static let monthsPerLeapYearCycle: Int = GregorianYear.yearsPerLeapYearCycle
    × GregorianYear.monthsPerYear
  ...
  public static var meanDuration: CalendarInterval<FloatMax> {
    return FloatMax(GregorianYear.daysPerLeapYearCycle).days
      ÷ FloatMax(GregorianYear.yearsPerLeapYearCycle)
  }
