...
public enum GregorianMonth: Int, CalendarComponent, ConsistentlyOrderedCalendarComponent & _StrideableIfNotInherited, Decodable, Encodable, EnumerationCalendarComponent, ICalendarComponent, ISOCalendarComponent, Month, TextualPlaygroundDisplay {
