...
extension Weekday {
    ...
    @inlinable @_versioned internal func aufDeutsch() -> StrictString {
        switch ordinal {
        case 1:
            return "Sonntag"
        case 2:
    ...
    @inlinable @_versioned internal func enFrançais(_ majuscules: Casing) -> StrictString {
        switch ordinal {
        case 1:
    ...
    @inlinable @_versioned internal func σεΕλληνικά() -> StrictString {
        switch ordinal {
        case 1:
            return "Κυριακή"
        case 2:
    ...
    @inlinable @_versioned internal func בעברית() -> StrictString {
