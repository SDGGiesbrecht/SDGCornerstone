...
// #workaround(This will probably be obsolete when SE-0194 is implemented. (Swift 4.1.2))
...
public protocol IterableEnumeration : RawRepresentable {
    // #workaround(This should be constrained to “where RawValue == Int”, but that triggers abort traps when Linux tries to link against it. (Swift 4.1.2))
