...
extension String.UnicodeScalarView : UnicodeScalarView {
    // [_Workaround: The previous line should read “String.ScalarView” but a compiler bug prevents it. (Swift 4.0.2)_]
    ...
    public func firstMatch(for pattern: Pattern<Element>, in searchRange: Range<Index>? = nil) -> PatternMatch<String.ScalarView>? {
        ...
        // [_Workaround: This is redundant, but solves performance until generics can be forcibly specialized. (Swift 4.0.2)_]
