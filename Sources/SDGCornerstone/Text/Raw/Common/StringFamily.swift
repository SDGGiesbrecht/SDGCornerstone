...
extension StringFamily where Self.ScalarView.Index == String.UnicodeScalarView.Index /* [_Workaround: This where statement works around an abort trap. See UnicodeScalarView.swift. (Swift 4.0)_] */ {
    // MARK: - where ScalarView.Index == String.UnicodeScalarView.Index
