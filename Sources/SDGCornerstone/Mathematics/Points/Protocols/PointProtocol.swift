...
// [_Workaround: The next line causes an abort trap compile failure. (Swift 4.0.2)_]
...
extension /*PointProtocol where Self : */UIntFamily {
    ...
    public static func − (lhs: Self, rhs: Self) -> Stride {
        // [_Workaround: The following causes an EXC_BAD_INSTRUCTION. (Swift 4.0.2)_]
        //return rhs.distance(to: lhs)
...
extension UIntFamily {
    // [_Workaround: Should not be necessary but for the above workaround. (Swift 4.0.2)_]
