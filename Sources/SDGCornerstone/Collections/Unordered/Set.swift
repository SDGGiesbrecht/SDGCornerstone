...
extension Set : ComparableSet, FiniteSet, MutableSet, SetDefinition {
    ...
    public static func ⊆ (precedingValue: Set, followingValue: Set) -> Bool {
    ...
    public static func ∩ (precedingValue: Set, followingValue: Set) -> Set {
    ...
    ///     - precedingValue: A set.
    ///     - followingValue: Another set.
    public static func ∩= (precedingValue: inout Set, followingValue: Set) {
    ...
    public static func ∋ (precedingValue: Set, followingValue: Element) -> Bool {
