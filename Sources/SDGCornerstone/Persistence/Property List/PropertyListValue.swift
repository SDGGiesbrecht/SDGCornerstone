...
extension PropertyListValue {
    ...
    public var equatableRepresentation: EquatableRepresentation {
        if let result = self as? EquatableRepresentation {
            ...
            // [_Workaround: Linux does not bridge well yet. (Swift 4.0.2)_]
...
// [_Workaround: The following are temporary replacements for as?, because Linux doesn’t bridge well yet. (Swift 4.0.2)_]
