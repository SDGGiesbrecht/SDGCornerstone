...
public protocol RealArithmeticCore : RationalArithmeticCore {
...
@_transparent public func π<N : RealArithmeticCore>() -> N {
    return N.π
}
...
@_transparent public func τ<N : RealArithmeticCore>() -> N {
    return N.τ
}
...
@_transparent public func e<N : RealArithmeticCore>() -> N {
    return N.e
}
...
///     - base: The base.
///     - antilogarithm: The antilogarithm.
@_transparent public func log<N : RealArithmeticCore>(toBase base: N, of antilogarithm: N) -> N {
...
/// - Parameters:
///     - antilogarithm: The antilogarithm.
@_transparent public func log<N : RealArithmeticCore>(_ antilogarithm: N) -> N {
...
/// - Parameters:
///     - antilogarithm: The antilogarithm.
@_transparent public func ln<N : RealArithmeticCore>(_ antilogarithm: N) -> N {
...
/// - Parameters:
///     - sine: The sine.
@_transparent public func arcsin<N : RealArithmeticCore>(_ sine: N) -> Angle<N> {
...
/// - Parameters:
///     - cosine: The cosine.
@_transparent public func arccos<N : RealArithmeticCore>(_ cosine: N) -> Angle<N> {
...
/// - Parameters:
///     - tangent: The tangent.
@_transparent public func arctan<N : RealArithmeticCore>(_ tangent: N) -> Angle<N> {
...
/// - Parameters:
///     - cosecant: The cosecant.
@_transparent public func arccsc<N : RealArithmeticCore>(_ cosecant: N) -> Angle<N> {
...
/// - Parameters:
///     - secant: The secant.
@_transparent public func arcsec<N : RealArithmeticCore>(_ secant: N) -> Angle<N> {
...
/// - Parameters:
///     - tangent: The tangent.
@_transparent public func arccot<N : RealArithmeticCore>(_ cotangent: N) -> Angle<N> {
