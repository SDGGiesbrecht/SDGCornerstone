...
extension RealArithmetic {
  ...
  // #workaround(Swift 5.3.9, These can be removed when global generic constants are available.)
...
// #workaround(Swift 5.3.9, These should be switched to generic constants when they become available.)
