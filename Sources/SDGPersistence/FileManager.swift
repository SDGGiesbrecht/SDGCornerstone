...
#if canImport(Glibc)
// [_Workaround: See move method below. (Swift 4.1)_]
import Glibc
#endif
...
extension FileManager {
    ...
    public func move(_ source: URL, to destination: URL) throws {
        ...
        #if canImport(Glibc)
        // [_Workaround: Until Linux’ Foundation implements cross‐device moves. (Swift 4.1)_]
    ...
    public func deepFileEnumeration(in directory: URL) throws -> [URL] {
        ...
        for object in enumerator {
            ...
            #if os(Linux)
            // [_Workaround: Linux has no implementation for resourcesValues(forKeys:) (Swift 4.2)_]
