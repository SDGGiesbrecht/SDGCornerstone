...
@inlinable public func testNumericAdditiveArithmeticConformance<T>(augend: T, addend: T, sum: T, includingNegatives: Bool, file: StaticString = #file, line: UInt = #line) where T : NumericAdditiveArithmetic {
    ...
    if includingNegatives {
        test(property: ({ $0.isPositive }, "isPositive"), of: T.zero − augend, is: false, file: file, line: line)
    }
    ...
    if includingNegatives {
        test(property: ({ $0.isNegative }, "isNegative"), of: T.zero − augend, is: true, file: file, line: line)
    }

    test(property: ({ $0.isNonNegative }, "isNonNegative"), of: T.zero, is: true, file: file, line: line)
    test(property: ({ $0.isNonNegative }, "isNonNegative"), of: augend, is: true, file: file, line: line)
    if includingNegatives {
        test(property: ({ $0.isNonNegative }, "isNonNegative"), of: T.zero − augend, is: false, file: file, line: line)
    }

    test(property: ({ $0.isNonPositive }, "isNonPositive"), of: T.zero, is: true, file: file, line: line)
    test(property: ({ $0.isNonPositive }, "isNonPositive"), of: augend, is: false, file: file, line: line)
    if includingNegatives {
        test(property: ({ $0.isNonPositive }, "isNonPositive"), of: T.zero − augend, is: true, file: file, line: line)
    }

    test(property: ({ $0.absoluteValue }, "absoluteValue"), of: augend, is: augend, file: file, line: line)
    if includingNegatives {
        test(property: ({ $0.absoluteValue }, "absoluteValue"), of: T.zero − augend, is: augend, file: file, line: line)
    }

    test(mutatingMethod: ({ $0.formAbsoluteValue() }, "formAbsoluteValue"), of: augend, resultsIn: augend, file: file, line: line)
    if includingNegatives {
        test(mutatingMethod: ({ $0.formAbsoluteValue() }, "formAbsoluteValue"), of: T.zero − augend, resultsIn: augend, file: file, line: line)
    }
}
