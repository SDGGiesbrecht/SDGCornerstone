...
/// Tests a type’s conformance to RealArithmeticCore.
@_transparent public func testRealArithmeticCoreConformance<T>(of type: T.Type, file: StaticString = #file, line: UInt = #line) where T : RealArithmeticCore {

    testRationalArithmeticCoreConformance(of: T.self, file: file, line: line)
    ...
    test(function: (arcsin, "arcsin"), on: 1 ÷ 6, returns: (0.167_44 as T).rad, file: file, line: line)
    test(function: (arccos, "arccos"), on: 1 ÷ 7, returns: (1.427_44 as T).rad, file: file, line: line)
    test(function: (arctan, "arctan"), on: 1 ÷ 2, returns: (0.463_64 as T).rad, file: file, line: line)
    test(function: (arcsec, "arcsec"), on: 1 × 4, returns: (1.318_11 as T).rad, file: file, line: line)
