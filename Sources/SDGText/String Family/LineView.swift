...
// #workaround(Swift 5.1.5, Web doesn’t have foundation yet; compiler doesn’t recognize os(WASI).)
  ...
  public struct LineView<Base: StringFamily>: BidirectionalCollection, Collection,
    MutableCollection,
    RangeReplaceableCollection, TextualPlaygroundDisplay
  {
    ...
    @inlinable internal func line(for scalar: String.ScalarView.Index) -> LineViewIndex {
      ...
      guard
        var previousNewline = base.scalars[..<scalar].lastMatch(for: CharacterSet.newlinePattern)
      else {
        return startIndex
      }
