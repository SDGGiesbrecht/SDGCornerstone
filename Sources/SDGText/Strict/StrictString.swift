...
public struct StrictString: Addable, BidirectionalCollection, Collection, Comparable, Equatable,
  ...
  RangeReplaceableCollection, SearchableBidirectionalCollection, StringFamily, UnicodeScalarView,
  TextOutputStream, TextOutputStreamable, TextualPlaygroundDisplay
{
