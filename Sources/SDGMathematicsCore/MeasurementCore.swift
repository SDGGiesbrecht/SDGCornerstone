...
public protocol MeasurementCore : Negatable, NumericAdditiveArithmetic {
    ...
    /// A rule for rounding.
    typealias RoundingRule = WholeArithmeticCore.RoundingRule
...
///     - precedingValue: A value.
///     - followingValue: Another value.
@_transparent public func gcd<M : MeasurementCore>(_ a: M, _ b: M) -> M {
    return M.gcd(a, b)
}
...
///     - precedingValue: A value.
///     - followingValue: Another value.
@_transparent public func lcm<M : MeasurementCore>(_ a: M, _ b: M) -> M {
    return M.lcm(a, b)
}
...
/// Conformance Requirements:
///     - `Measurement`
public protocol CodableViaMeasurement : MeasurementCore {
