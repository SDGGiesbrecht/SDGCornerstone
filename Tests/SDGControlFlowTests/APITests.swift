...
class APITests: TestCase {
  ...
  func testTuple() {
    ...
    testComparableConformance(less: Tuple6((0, 1, 2, 3, 4, 5)), greater: Tuple6((1, 2, 3, 4, 5, 6)))
    ...
    testHashableConformance(differingInstances: (Tuple5((0, 1, 2, 3, 4)), Tuple5((1, 2, 3, 4, 5))))
