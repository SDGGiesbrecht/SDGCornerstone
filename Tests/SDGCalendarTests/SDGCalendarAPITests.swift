...
class SDGCalendarAPITests : TestCase {
    ...
    func testCalendarDate() {
        ...
        for n in 1 ... 12 {
            ...
            testCustomStringConvertibleConformance(of: date, localizations: FormatLocalization.self, uniqueTestName: "Gregorian (" + date.dateInISOFormat() + ")", overwriteSpecificationInsteadOfFailing: false)
        }
        let bc = CalendarDate(gregorian: .january, 1, GregorianYear(−2000))
        testCustomStringConvertibleConformance(of: bc, localizations: FormatLocalization.self, uniqueTestName: "Gregorian (" + bc.dateInISOFormat() + ")", overwriteSpecificationInsteadOfFailing: false)
        for n in 1 ... 12 {
            ...
            testCustomStringConvertibleConformance(of: date, localizations: FormatLocalization.self, uniqueTestName: "Hebrew (" + date.dateInISOFormat() + ")", overwriteSpecificationInsteadOfFailing: false)
        }
        for n in 21 ... 22 {
            let adar = CalendarDate(hebrew: .adarI, 1, 5700 + n)
            testCustomStringConvertibleConformance(of: adar, localizations: FormatLocalization.self, uniqueTestName: "Hebrew (" + adar.dateInISOFormat() + ")", overwriteSpecificationInsteadOfFailing: false)
        }
